...
export const messages: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'chat.stepDown': '减小',
    'chat.stepUp': '增大',
    // Generation presets (sampling quick profiles, borrowed from unsloth)
    'chat.genPreset': '采样预设',
    'chat.presetSummaryHint': '采样参数由预设控制，在顶部工具栏切换',
    'chat.presetDefault': '默认（跟随模型设置）',
    'chat.presetPrecise': '精确',
    'chat.presetBalanced': '均衡',
    'chat.presetCreative': '创意',
    'chat.presetRandom': '随机',
    'chat.presetManage': '管理预设',
    'chat.presetSaveAs': '将当前预设另存为',
    'chat.presetNamePh': '输入预设名称',
    'chat.presetSave': '保存',
    'chat.presetDelete': '删除',
    'chat.presetClose': '关闭',
    'chat.presetCustomList': '自定义预设（最多 20 个）',
    'chat.presetBadName': '名称无效：不能为空、超过 40 字或含换行符',
    'chat.presetCapReached': '自定义预设已达上限（20 个），请先删除不需要的预设',
    'chat.presetSamplingEdit': '采样参数（可编辑，随自定义预设保存）',
    'chat.presetBadSampling': '采样参数超出允许范围',
    // Quantize tool (desktop only; llama-quantize driver)
    'quantize.menu': '量化…',
    'quantize.title': '量化模型',
    'quantize.src': '源文件 (.gguf)',
    'quantize.type': '目标量化',
    'quantize.typeHint': 'q4_k_m 体积/质量均衡（推荐）；q5_k_m / q8_0 更高质量；f16 无损最高质量',
    'quantize.out': '输出文件名',
    'quantize.outHint': '输出保存在源文件同一目录；文件名冲突会明确报错',
    'quantize.run': '开始量化',
    'quantize.running': '量化进行中…',
    'quantize.cancel': '取消',
    'quantize.done': '量化完成',
    'quantize.failed': '量化失败',
    'quantize.doneHint': '量化完成。新文件与源模型同目录，回到「我的模型」刷新即可查看',
    'quantize.again': '再量化一次',
    'quantize.close': '关闭',
    'quantize.hide': '后台运行',
    ...
    'modelSettings.specTypeHint': 'MTP 投机预测需模型支持；ngram-simple / ngram-mod 为 n-gram 自投机，无需草稿模型、零额外显存，对重复/结构化输出有加速，其他场景可能变慢；留空关闭',
    ...
    // LoRA adapter tab (ModelSettings page): adapter mounts for the model
    'modelSettings.tabLora': 'LoRA 适配器',
    'modelSettings.loraHint': '把 Unsloth 等工具导出的 LoRA 适配器 GGUF 放入适配器目录，即可在此挂载;随服务启动加载',
    'modelSettings.loraRefresh': '刷新扫描',
    'modelSettings.loraEmptyTitle': '尚未发现 LoRA 适配器',
    'modelSettings.loraEmpty': '把 Unsloth 导出的 LoRA GGUF 放入「模型下载目录/lora」文件夹，然后点击「刷新扫描」',
    'modelSettings.loraNotAdapter': '非适配器文件',
    'modelSettings.loraMissing': '文件已移除',
    'modelSettings.loraScale': '权重',
    'modelSettings.loraScaleHint': '0–4,默认 1.0;越大适配器影响越强',
    'modelSettings.loraAlpha': 'Alpha {alpha}',
    'modelSettings.loraSave': '保存适配器',
    'modelSettings.loraSaved': '✓ 适配器设置已保存',
    'modelSettings.loraApply': '应用到运行中服务',
    'modelSettings.loraApplying': '应用中...',
    'modelSettings.loraApplied': '✓ 已热更到运行中的服务',
    'modelSettings.loraApplyFailed': '热更未生效，将在下次启动服务时生效：{msg}',
    'modelSettings.loraLoadFailed': '适配器加载失败:{msg}',
    'modelSettings.loraActiveCount': '已启用 {n} 个适配器',
  ...
  en: {
    ...
    // Generation presets (sampling quick profiles, borrowed from unsloth)
    'chat.genPreset': 'Sampling preset',
    'chat.presetSummaryHint': 'Sampling parameters follow the preset; switch it in the toolbar',
    'chat.presetDefault': 'Default (model settings)',
    'chat.presetPrecise': 'Precise',
    'chat.presetBalanced': 'Balanced',
    'chat.presetCreative': 'Creative',
    'chat.presetRandom': 'Random',
    'chat.presetManage': 'Manage presets',
    'chat.presetSaveAs': 'Save current preset as',
    'chat.presetNamePh': 'Preset name',
    'chat.presetSave': 'Save',
    'chat.presetDelete': 'Delete',
    'chat.presetClose': 'Close',
    'chat.presetCustomList': 'Custom presets (max 20)',
    'chat.presetBadName': 'Invalid name: must be non-empty, at most 40 chars, no line breaks',
    'chat.presetCapReached': 'Custom preset cap reached (20); delete one first',
    'chat.presetSamplingEdit': 'Sampling parameters (editable, saved with the custom preset)',
    'chat.presetBadSampling': 'Sampling parameters out of range',
    // Quantize tool (desktop only; llama-quantize driver)
    'quantize.menu': 'Quantize…',
    'quantize.title': 'Quantize model',
    'quantize.src': 'Source file (.gguf)',
    'quantize.type': 'Target quantization',
    'quantize.typeHint': 'q4_k_m balances size/quality (recommended); q5_k_m / q8_0 higher quality; f16 lossless',
    'quantize.out': 'Output file name',
    'quantize.outHint': 'The output lands next to the source file; a name conflict fails explicitly',
    'quantize.run': 'Start quantization',
    'quantize.running': 'Quantizing…',
    'quantize.cancel': 'Cancel',
    'quantize.done': 'Quantization finished',
    'quantize.failed': 'Quantization failed',
    'quantize.doneHint': 'Done. The new file sits next to the source; refresh "My Models" to see it',
    'quantize.again': 'Quantize again',
    'quantize.close': 'Close',
    'quantize.hide': 'Keep running',
    // Phone-tier two-line empty states (design draft frames ⑤⑦ .emptystate)
    ...
    'modelSettings.specTypeHint': 'MTP speculative prediction requires model support; ngram-simple / ngram-mod are n-gram self-speculation — no draft model, zero extra VRAM; helps repetitive/structured output, can regress elsewhere; empty disables',
    ...
    // LoRA adapter tab (ModelSettings page): adapter mounts for the model
    'modelSettings.tabLora': 'LoRA Adapters',
    'modelSettings.loraHint': 'Drop LoRA adapter GGUFs exported by Unsloth and friends into the adapter directory to mount them here; they load with the service',
    'modelSettings.loraRefresh': 'Rescan',
    'modelSettings.loraEmptyTitle': 'No LoRA adapters found',
    'modelSettings.loraEmpty': 'Put Unsloth-exported LoRA GGUFs into the "model download dir/lora" folder, then hit Rescan',
    'modelSettings.loraNotAdapter': 'Not an adapter',
    'modelSettings.loraMissing': 'File removed',
    'modelSettings.loraScale': 'Scale',
    'modelSettings.loraScaleHint': '0–4, default 1.0; higher means a stronger adapter effect',
    'modelSettings.loraAlpha': 'Alpha {alpha}',
    'modelSettings.loraSave': 'Save Adapters',
    'modelSettings.loraSaved': '✓ Adapter settings saved',
    'modelSettings.loraApply': 'Apply to Running Service',
    'modelSettings.loraApplying': 'Applying...',
    'modelSettings.loraApplied': '✓ Hot-applied to the running service',
    'modelSettings.loraApplyFailed': 'Hot-apply did not take effect; changes apply on the next service start: {msg}',
    'modelSettings.loraLoadFailed': 'Failed to load adapters: {msg}',
    'modelSettings.loraActiveCount': '{n} adapter(s) enabled',
